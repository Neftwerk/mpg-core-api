import { ForbiddenException, Inject, Injectable, Type } from '@nestjs/common';
...
@Injectable()
export class DeleteBookPolicyHandler implements IPolicyHandler {
  ...
  constructor(
    ...
    private readonly genreRepository: IBookRepository,
  ) {
    this.policyHandlerStorage.add(DeleteBookPolicyHandler, this);
  }
